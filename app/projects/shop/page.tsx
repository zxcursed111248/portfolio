        ...
        <div className="relative mx-auto max-w-6xl px-6 py-24 md:py-32">
          ...
          >
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-zinc-400 md:text-xl">
              Современная концепция интернет-магазина с удобной
              структурой каталога, понятной навигацией и акцентом
        ...
        <div className="grid gap-16 md:grid-cols-[1fr_1.5fr]">
          ...
          <div>
            <p className="leading-8 text-zinc-400">
              Задача проекта — создать современное представление
              интернет-магазина, в котором пользователь сможет
              быстро найти нужный товар и пройти путь от просмотра
              каталога до покупки.
            </p>
            ...
            <div className="mt-10 space-y-5">
              {[
                ...
                "Каталог товаров",
                "Удобная навигация",
                "Современная визуальная подача товаров",
                "Структура, подготовленная для онлайн-продаж",
              ].map((item) => (
                <div
                  key={item}
      ...
      <section className="mx-auto max-w-6xl px-6 pb-32">
        <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-10 text-center md:p-16">
          ...
          <p className="mx-auto mt-6 max-w-xl leading-7 text-zinc-400">
            Расскажите о своих товарах и задаче — обсудим
            структуру, дизайн и возможности проекта.
          </p>
